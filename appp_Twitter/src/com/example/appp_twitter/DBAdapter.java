...
public long insert(String name, String email,String pass)
{
...
KEY_EMAIL,KEY_PASS}, null, null, null, null, KEY_NAME);
}
...
KEY_NAME, KEY_EMAIL,KEY_PASS}, KEY_ROWID + "=" + rowId, null,
null, null, null, null);
if (mCursor != null) {
mCursor.moveToFirst();
}
